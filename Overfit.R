#Simple illustration of overfitting
#Although the R2 of the polynomial model is higher, its prediction of the red point has no sense.
...
mod5=lm(Y~X+I(X^2)+I(X^3)+I(X^4)+I(X^5)+I(X^6)+I(X^7)+I(X^8)+I(X^9)+I(X^10)+
          I(X^11)+I(X^12)+I(X^13)+I(X^14)+I(X^15)+I(X^16)+I(X^17))
summary(mod5)
lines(Xp,predict(mod5, newdata=data.frame(X=Xp)),col="blue",lwd=2)
title("Typical example of an overfitted model (blue curve)")